 ...
 */
public class EditMedia extends javax.swing.JFrame {

    /**
     * Creates new form EditCrewRoles
     */
    public EditMedia(DBManager DB) {
        this.DB = DB;
    ...
    private void loadMedia() {
        String sql = "SELECT MediaID, Name FROM Media;";
    ...
    private void initComponents() {
        ...
        jLabelNewMedia = new javax.swing.JLabel();
        ...
        jLabelNewMedia.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jLabelNewMedia.setText("New Media");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 0, 0);
        jPanelMain.add(jLabelNewMedia, gridBagConstraints);

        jTableMedia.setAutoCreateRowSorter(true);
        ...
        jButtonRemove.setText("Remove Media");
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        jLabelNewMedia.setForeground(Color.black);
        String newMedia = jTextFieldNewMedia.getText();
        
        if (newMedia.isBlank()) {
            jLabelNewMedia.setForeground(Color.red);
            return;
        }
        
        String sql = "INSERT INTO Media (MediaID, Name, Description) VALUES (null, ?, null);";
    ...
    private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveActionPerformed
        ...
        Integer selectedID = (Integer) Utils.getSelectedCellContent(selectedRow, 0, jTableMedia);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditMedia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditMedia(null).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabelNewMedia;
