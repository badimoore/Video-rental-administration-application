 ...
 */
public class EditLanguages extends javax.swing.JFrame {

    /**
     * Creates new form EditCrewRoles
     */
    public EditLanguages(DBManager DB) {
        this.DB = DB;
    ...
    private void initComponents() {
        ...
        jLabelNewLanguage = new javax.swing.JLabel();
        ...
        jTextFieldNewLanguage.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jTextFieldNewLanguage.setMinimumSize(new java.awt.Dimension(140, 22));
        jTextFieldNewLanguage.setPreferredSize(new java.awt.Dimension(140, 22));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(8, 5, 0, 0);
        jPanelMain.add(jTextFieldNewLanguage, gridBagConstraints);

        jLabelNewLanguage.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jLabelNewLanguage.setText("New Language");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 0, 0);
        jPanelMain.add(jLabelNewLanguage, gridBagConstraints);
        ...
        jButtonAdd.setText("Add Language");
        ...
        jButtonRemove.setText("Remove Language");
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        jLabelNewLanguage.setForeground(Color.black);
        String newLanguage = jTextFieldNewLanguage.getText();
        
        if (newLanguage.isBlank()) {
            jLabelNewLanguage.setForeground(Color.red);
            return;
        }
        
        String sql = "INSERT INTO Language (LanguageID, Name) VALUES (null, ?);";
    ...
    private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveActionPerformed
        ...
        Integer selectedID = (Integer) Utils.getSelectedCellContent(selectedRow, 0, jTableLanguages);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditLanguages.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditLanguages(null).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabelNewLanguage;
