...
public class EditGenres extends javax.swing.JFrame {
     ...
     */
    public EditGenres(DBManager DB) {
        this.DB = DB;
    ...
    private void initComponents() {
        ...
        jLabelNewGenre = new javax.swing.JLabel();
        ...
        jTextFieldNewGenre.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jTextFieldNewGenre.setMinimumSize(new java.awt.Dimension(140, 22));
        jTextFieldNewGenre.setPreferredSize(new java.awt.Dimension(140, 22));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(8, 5, 0, 0);
        jPanelMain.add(jTextFieldNewGenre, gridBagConstraints);

        jLabelNewGenre.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jLabelNewGenre.setText("New Genre");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 0, 0);
        jPanelMain.add(jLabelNewGenre, gridBagConstraints);

        jTableGenres.setAutoCreateRowSorter(true);
        ...
        jButtonRemove.setText("Remove Genre");
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        jLabelNewGenre.setForeground(Color.black);
        String newGenre = jTextFieldNewGenre.getText();
        
        if (newGenre.isBlank()) {
            jLabelNewGenre.setForeground(Color.red);
            return;
        }
        
        String sql = "INSERT INTO Genre (GenreID, Name, Description) VALUES (null, ?, null);";
    ...
    private void jButtonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRemoveActionPerformed
        ...
        Integer selectedID = (Integer) Utils.getSelectedCellContent(selectedRow, 0, jTableGenres);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditGenres(null).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabelNewGenre;
